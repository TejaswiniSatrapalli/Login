...
public class TransactionServiceImpl implements TransactionService{
	...
	public TransactionDto saveTransaction(TransactionDto transactionDto) {
		...
		double convertedAmount = transactionDto.getSendingAmount() - (transactionDto.getSendingAmount() * 0.1) - 0;
		double totalAmount = convertedAmount * rate ;
	...
	public List<Transaction> getTransactionByUserId(int userId) {
		long accNo = userBankDetailsRepository.findByUser_UsersId(userId).getAccountNumber();
